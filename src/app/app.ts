...
export class App {
  ...
  constructor(private router: Router) {
    this.router.events
      ...
      .subscribe((event: any) => {
        const hiddenRoutes = ['/inicio', '/login', '/registro', '/configuracion', '/parametros-generales', '/config-correo', '/eventos', '/historial-notificaciones', '/notificaciones-email', '/certificado-digital'];
